...
public class TS001Set2 extends BaseClass {
    ...
    void TC_RF_003()  {
        ...
        Assert.assertEquals(registrationPage.getPageTitle(),expected);
    }
    ...
    void TC_RF_005(){
        ...
        headerPage.setMyAccount(HomePageEnums.MyAccount.REGISTER);
        RegistrationPage registrationPage=new RegistrationPage(driver);
        registrationPage.accountRegister((String) data[0],(String) data[1],(String) data[2],(String) data[3], RegistrationPage.PrivacyPolicyOption.ENABLED, RegistrationPage.NewsletterOption.SUBSCRIBED);

        String expected1 ="Your Account Has Been Created!";
        softAssert.assertEquals(registrationPage.getPageTitle(),expected1);
        MyAccountPage myAccountPage=new MyAccountPage(driver);
        myAccountPage.navigateToNewsLetterPage();
    ...
    void TC_RF_009(){
        ...
        registrationPage.setEmail("TrailTest@-gmail.com");
        registrationPage.clickSubmitButton();
        String expected5=registrationPage.getEmailValidationMessage();
        ...
        softAssert.assertEquals("Please include an'@' in the email address.",expected3);
        softAssert.assertEquals("A part following '@' should not contain the symbol",expected4);
        softAssert.assertEquals("Please enter an email address.",expected5);
        softAssert.assertAll();
    }
    ...
    void TC_RF_010(){
        ...
        String expected1 ="Your Account Has Been Created!";
        Assert.assertEquals(registrationPage.getPageTitle(),expected1);
    }
    ...
    void TC_RF_014(){
        ...
        softAssert.assertEquals("hazlewood@gmail.com",email);
        softAssert.assertAll();
